...
attraction1.avatar = File.open("#{source}/images/chez_pascal.jpg")
attraction1.save
...
attraction2.avatar = File.open("#{source}/images/broadway_bistro.jpg")
attraction2.save
...
attraction3.avatar = File.open("#{source}/images/as220.jpg")
attraction3.save
...
attraction4.avatar = File.open("#{source}/images/los_andes.jpg")
attraction4.save
...
attraction5.avatar = File.open("#{source}/images/eastside.jpg")
attraction5.save
...
attraction6.avatar = File.open("#{source}/images/pastiche.jpg")
attraction6.save
...
attraction7.avatar = File.open("#{source}/images/gracies.jpg")
attraction7.save
...
attraction8.avatar = File.open("#{source}/images/nicks.jpg")
attraction8.save
...
attraction9.avatar = File.open("#{source}/images/kitchen.jpg")
attraction9.save
...
attraction10.avatar = File.open("#{source}/images/ppac.jpg")
attraction10.save
...
attraction11.avatar = File.open("#{source}/images/flan.jpg")
attraction11.save
...
attraction12.avatar = File.open("#{source}/images/seven_stars.jpg")
attraction12.save
...
attraction13.avatar = File.open("#{source}/images/mama.jpg")
attraction13.save
...
attraction14.avatar = File.open("#{source}/images/blackstone.jpg")
attraction14.save
...
attraction15.avatar = File.open("#{source}/images/al_forno.jpg")
attraction15.save
...
attraction16.avatar = File.open("#{source}/images/farmstead.jpg")
attraction16.save
...
attraction17.avatar = File.open("#{source}/images/nice_slice.jpg")
attraction17.save
...
attraction18.avatar = File.open("#{source}/images/coffex.jpg")
attraction18.save
...
attraction19.avatar = File.open("#{source}/images/el_rancho.jpg")
attraction19.save
...
attraction20.avatar = File.open("#{source}/images/dorrance.jpg")
attraction20.save
...
attraction21.avatar = File.open("#{source}/images/apsara.jpg")
attraction21.save
...
attraction22.avatar = File.open("#{source}/images/duck.jpg")
attraction22.save
...
attraction23.avatar = File.open("#{source}/images/salon.jpg")
attraction23.save
...
attraction24.avatar = File.open("#{source}/images/kabob.jpg")
attraction24.save
...
attraction25.avatar = File.open("#{source}/images/abyssinia.jpg")
attraction25.save
...
attraction26.avatar = File.open("#{source}/images/snacks.jpg")
attraction26.save
...
attraction27.avatar = File.open("#{source}/images/local.jpg")
attraction27.save
...
attraction28.avatar = File.open("#{source}/images/risd_museum.jpg")
attraction28.save
...
attraction29.avatar = File.open("#{source}/images/haruki.jpg")
attraction29.save
...
attraction30.avatar = File.open("#{source}/images/sisters.jpg")
attraction30.save
...
attraction31.avatar = File.open("#{source}/images/fellini.jpg")
attraction31.save
...
attraction32.avatar = File.open("#{source}/images/harrys.jpg")
attraction32.save
...
attraction33.avatar = File.open("#{source}/images/angkor.jpg")
attraction33.save
...
attraction34.avatar = File.open("#{source}/images/antonios.jpg")
attraction34.save
...
attraction35.avatar = File.open("#{source}/images/teriyaki.jpg")
attraction35.save
...
attraction36.avatar = File.open("#{source}/images/gcb.jpg")
attraction36.save
...
attraction37.avatar = File.open("#{source}/images/geoffs.jpg")
attraction37.save
...
attraction38.avatar = File.open("#{source}/images/juniper.jpg")
attraction38.save
...
attraction39.avatar = File.open("#{source}/images/lolas.jpg")
attraction39.save
...
attraction40.avatar = File.open("#{source}/images/mikes.jpg")
attraction40.save
...
attraction41.avatar = File.open("#{source}/images/creperie.jpg")
attraction41.save
...
attraction42.avatar = File.open("#{source}/images/prospect_park.jpg")
attraction42.save
...
attraction43.avatar = File.open("#{source}/images/mijos.jpg")
attraction43.save
...
attraction44.avatar = File.open("#{source}/images/blue_state.jpg")
attraction44.save
...
attraction45.avatar = File.open("#{source}/images/rocket.jpg")
attraction45.save
...
attraction46.avatar = File.open("#{source}/images/tea_in_sahara.jpg")
attraction46.save
...
attraction47.avatar = File.open("#{source}/images/trinity.jpg")
attraction47.save
...
attraction48.avatar = File.open("#{source}/images/bagel.jpg")
attraction48.save
...
attraction49.avatar = File.open("#{source}/images/tealuxe.jpg")
attraction49.save
...
attraction50.avatar = File.open("#{source}/images/paragon.jpg")
attraction50.save
...
attraction51.avatar = File.open("#{source}/images/point.jpg")
attraction51.save
...
attraction52.avatar = File.open("#{source}/images/trinity_rep.jpg")
attraction52.save
...
attraction53.avatar = File.open("#{source}/images/louis.jpg")
attraction53.save
...
attraction54.avatar = File.open("#{source}/images/small_point.jpg")
attraction54.save
...
attraction55.avatar = File.open("#{source}/images/swan_point.jpg")
attraction55.save
...
attraction56.avatar = File.open("#{source}/images/wild_colonial.jpg")
attraction56.save
...
attraction57.avatar = File.open("#{source}/images/gourmet_house.jpg")
attraction57.save
...
attraction58.avatar = File.open("#{source}/images/india_point.jpg")
attraction58.save
...
attraction59.avatar = File.open("#{source}/images/four_seasons.jpg")
attraction59.save
...
attraction60.avatar = File.open("#{source}/images/pvd_pudding.jpg")
attraction60.save
...
attraction61.avatar = File.open("#{source}/images/ranzan.jpg")
attraction61.save
...
attraction62.avatar = File.open("#{source}/images/union.jpg")
attraction62.save
...
attraction63.avatar = File.open("#{source}/images/olive.jpg")
attraction63.save
...
attraction64.avatar = File.open("#{source}/images/waterplace.jpg")
attraction64.save
...
attraction65.avatar = File.open("#{source}/images/alehouse.jpg")
attraction65.save
...
attraction66.avatar = File.open("#{source}/images/taste_india.jpg")
attraction66.save
...
attraction67.avatar = File.open("#{source}/images/east_bay.jpg")
attraction67.save
...
attraction68.avatar = File.open("#{source}/images/olneyville.jpg")
attraction68.save